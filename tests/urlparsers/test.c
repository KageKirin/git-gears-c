/* Generated by re2c 1.3 on Thu Feb 20 15:46:53 2020 */
#line 1 "src/urlparsers/test.re"
#include <stdlib.h>
#include <stdio.h>
#include <string.h>
...
yy2:
	++in->cur;
#line 137 "src/urlparsers/test.re"
	{ *count = c; return 0; }
#line 208 "<stdout>"
yy4:
	++in->cur;
yy5:
#line 136 "src/urlparsers/test.re"
	{ return 1; }
#line 214 "<stdout>"
yy6:
	++in->cur;
#line 138 "src/urlparsers/test.re"
	{ goto loop; }
#line 219 "<stdout>"
yy8:
	yyaccept = 0;
...
yy13:
	...
	f1 = in->yyt7;
	f2 = in->yyt8;
#line 139 "src/urlparsers/test.re"
	{
        ++c;
        printf("URI %ld:\n", c);
        printf("  scheme:   %.*s\n", (int)(s2 - s1), s1);
...
#line 155 "src/urlparsers/test.re"
